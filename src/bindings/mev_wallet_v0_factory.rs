...
pub mod mev_wallet_v0_factory {
    ...
    pub static MEVWALLETV0FACTORY_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static MEVWALLETV0FACTORY_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static MEVWALLETV0FACTORY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct MevWalletV0Factory<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MevWalletV0Factory<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MevWalletV0Factory<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MevWalletV0Factory<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MevWalletV0Factory<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(MevWalletV0Factory)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::ContractRevert for MevWalletV0FactoryErrors {
    ...
    impl ::core::fmt::Display for MevWalletV0FactoryErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for MevWalletV0FactoryErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<CreationFailed> for MevWalletV0FactoryErrors {
        fn from(value: CreationFailed) -> Self {
            Self::CreationFailed(value)
        }
    }
    impl ::core::convert::From<InitFailed> for MevWalletV0FactoryErrors {
    ...
    impl ::core::fmt::Display for MevWalletV0FactoryCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::CreateWalletWithOwner(element) => {
    ...
    impl ::core::convert::From<CreateWalletWithOwnerCall> for MevWalletV0FactoryCalls {
        fn from(value: CreateWalletWithOwnerCall) -> Self {
            Self::CreateWalletWithOwner(value)
        }
    }
    impl ::core::convert::From<CreateWalletCall> for MevWalletV0FactoryCalls {
