...
pub mod mev_wallet_v1 {
    ...
    pub static MEVWALLETV1_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    pub static MEVWALLETV1_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static MEVWALLETV1_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct MevWalletV1<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MevWalletV1<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MevWalletV1<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MevWalletV1<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MevWalletV1<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(MevWalletV1)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::ContractRevert for MevWalletV1Errors {
    ...
    impl ::core::fmt::Display for MevWalletV1Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for MevWalletV1Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<ExactBaseFee> for MevWalletV1Errors {
        fn from(value: ExactBaseFee) -> Self {
            Self::ExactBaseFee(value)
        }
    }
    impl ::core::convert::From<HighBaseFee> for MevWalletV1Errors {
        fn from(value: HighBaseFee) -> Self {
            Self::HighBaseFee(value)
        }
    }
    impl ::core::convert::From<MissingNonce> for MevWalletV1Errors {
        fn from(value: MissingNonce) -> Self {
            Self::MissingNonce(value)
        }
    }
    impl ::core::convert::From<NotBefore> for MevWalletV1Errors {
        fn from(value: NotBefore) -> Self {
            Self::NotBefore(value)
        }
    }
    impl ::core::convert::From<PermanentlyInvalid> for MevWalletV1Errors {
        fn from(value: PermanentlyInvalid) -> Self {
            Self::PermanentlyInvalid(value)
        }
    }
    impl ::core::convert::From<ProvideValue> for MevWalletV1Errors {
        fn from(value: ProvideValue) -> Self {
            Self::ProvideValue(value)
        }
    }
    impl ::core::convert::From<Reverted> for MevWalletV1Errors {
        fn from(value: Reverted) -> Self {
            Self::Reverted(value)
        }
    }
    impl ::core::convert::From<UsedNonce> for MevWalletV1Errors {
        fn from(value: UsedNonce) -> Self {
            Self::UsedNonce(value)
        }
    }
    impl ::core::convert::From<WrongSigner> for MevWalletV1Errors {
    ...
    impl ::core::fmt::Display for MevWalletV1Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<TxTypehashCall> for MevWalletV1Calls {
        fn from(value: TxTypehashCall) -> Self {
            Self::TxTypehash(value)
        }
    }
    impl ::core::convert::From<DomainSeparatorCall> for MevWalletV1Calls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for MevWalletV1Calls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<MevTxCall> for MevWalletV1Calls {
        fn from(value: MevTxCall) -> Self {
            Self::MevTx(value)
        }
    }
    impl ::core::convert::From<NonceCall> for MevWalletV1Calls {
        fn from(value: NonceCall) -> Self {
            Self::Nonce(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for MevWalletV1Calls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for MevWalletV1Calls {
